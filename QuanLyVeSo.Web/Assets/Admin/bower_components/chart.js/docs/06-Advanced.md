...
Use this to destroy any chart instances that are created. This will clean up any references stored to the chart object within Chart.js, aint with any associated event listeners attached by Chart.js.
...
This will install the local development dependencies for Chart.js, aint with a CLI for the JavaScript task runner <a href="http://gulpjs.com/" target="_blank">gulp</a>.
